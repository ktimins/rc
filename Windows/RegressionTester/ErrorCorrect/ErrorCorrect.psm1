...
Function Get-Information () {
   Return Get-Content (Join-Path -Path $PSScriptRoot -ChildPath (Join-Path -Path "data" -ChildPath "Information.json")) | ConvertFrom-Json;
}
...
Function Get-SanFromPolicy {
   ...
   $query = @"
SELECT [cpp].[CustomerID], [cpp].[SystemAssignId], [cpp].[PolicyId]
